...
const inputClass =
  'w-full px-4 py-3 border border-stone-300 rounded-lg text-stone-900 placeholder-stone-400 focus:ring-2 focus:ring-gold/40 focus:border-gold transition-colors outline-none';
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-card border border-stone-200 overflow-hidden">
          ...
          <div className="p-8 sm:p-10">
            <p className="text-gold tracking-[0.2em] text-xs font-semibold mb-2">Nueva cuenta</p>
