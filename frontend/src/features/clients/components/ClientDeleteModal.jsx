/**
 * Modal de confirmación para eliminar cliente — overlay a pantalla completa.
 */
...
export default function ClientDeleteModal({
  ...
  return createPortal(
    ...
    >
      <div className="bg-white rounded-2xl border border-stone-200 shadow-2xl p-6 max-w-sm w-full relative overflow-hidden opacity-100">
        ...
        <h3 id="client-delete-title" className="font-serif text-lg font-bold text-stone-900 text-center mb-2">
          ¿Eliminar cliente?
        </h3>
        ...
        <p className="text-stone-500 text-xs sm:text-sm text-center leading-relaxed mb-6">
          ...
          <strong className="text-stone-850 font-bold">{clientName}</strong>? Esta acción no se puede deshacer.
        </p>
