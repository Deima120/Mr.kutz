          ...
          isAdmin ? (
            <div className="flex gap-2">
              <button
                ...
                className="btn-admin-outline hover:text-gold hover:bg-stone-100 transition-colors"
              >
                Exportar CSV
              </button>
              <button type="button" onClick={printAsPDF} className="btn-admin-outline hover:text-gold hover:bg-stone-100 transition-colors">
                Exportar PDF
              </button>
