  ...
  return useRoutes([
    {
      ...
      children: [
        ...
        { path: 'appointments/new', element: protectedPage(AppointmentsPage, ['admin', 'barber', 'client']) },
        { path: 'appointments/:id/edit', element: protectedPage(AppointmentsPage, ['admin', 'barber', 'client']) },
