...
export default function StatsCard({
  ...
  const valueClass = emphasizeValue
    ? `font-serif font-medium mt-2 ${variant === 'primary' ? 'text-white' : 'text-stone-900'} text-3xl md:text-4xl lg:text-[2.75rem] leading-none tracking-tight`
    : `font-serif text-2xl md:text-3xl font-medium mt-2 ${variant === 'primary' ? 'text-white' : 'text-stone-900'}`;
