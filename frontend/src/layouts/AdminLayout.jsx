          ...
          {navSections.map((section) => {
            ...
            return (
              <div key={section.id} className="mb-2">
                ...
                >
                  <ul className="min-h-0 overflow-hidden space-y-1">
                      ...
                      return (
                        <li key={item.path}>
                          <Link
                            ...
                            className={`group relative flex items-center gap-3 rounded-2xl px-3 py-3 text-sm font-semibold transition-all duration-300 ${
                              active
                                ? 'bg-white text-barber-dark shadow-[0_18px_40px_rgba(255,255,255,0.12)]'
                          ...
                          >
                            ...
                            <span className={`min-w-0 flex-1 ${sidebarCollapsed ? 'lg:hidden' : 'block'}`}>
                              ...
                              <span className={`block truncate text-xs font-medium ${active ? 'text-stone-500' : 'text-stone-600 group-hover:text-stone-400'}`}>
                                {item.description}
                              </span>
                            </span>
                          </Link>
